# 1 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c"
...
# 1 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
# 2 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
# 3 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
# 4 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
login()
{
	...
	lr_end_transaction("log",2);

	return 0;
}
# 5 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
# 6 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
# 7 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
booking()
{
	...
	web_submit_data("BookHotel.php",
		...
		"Name=location_0", "Value={location}", "ENDITEM",
		...
		"Name=room_type_0", "Value={room_type}", "ENDITEM",
		...
		"Name=location_name", "Value={location}", "ENDITEM",
		"Name=room_types", "Value={room_type}", "ENDITEM",
	...
	web_submit_data("BookingConfirm.php",
		...
		"Name=location_name_hid", "Value={location}", "ENDITEM",
		"Name=room_types_hid", "Value={room_type}", "ENDITEM",
	...
	lr_end_transaction("book",2);

	return 0;
}
# 8 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
...
# 9 "c:\\users\\administrator\\documents\\vugen\\scripts\\loadproject\\\\combined_loadproject.c" 2
